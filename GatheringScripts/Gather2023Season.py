...
async def main():
        async with aiohttp.ClientSession(cookies={'beget':'begetok'}) as session:
            ...
            for i, x in enumerate(UniqDates):
                ...
                table = await understat.get_league_table("EPL", "2023", end_date=UniqDates[i])
            ...
            TELIKO.to_csv('~/Documents/EnglishPremierLeaguePredictor/GatheredData/Full20xxFiles/Full2023.csv')
